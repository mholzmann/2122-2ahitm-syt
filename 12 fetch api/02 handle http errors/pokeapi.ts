...
const pokemonForm: HTMLFormElement = <HTMLFormElement> document.getElementById("pokemon-form");
...
async function loadPokemon() {
    ...
    const pokemonInput: HTMLInputElement = <HTMLInputElement> document.getElementById("pokemon");
